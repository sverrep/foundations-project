...
export function render() {
  ...
  {
    ctx.drawImage(tile_sheet.image, player.animation.frame * tile_sheet.tile_size, tile_sheet.tile_size, tile_sheet.tile_size, tile_sheet.tile_size, player.x, player.y, tile_sheet.tile_size*4, tile_sheet.tile_size*4);
  }
  else
  {
    ctx.drawImage(tile_sheet.image, player.animation.frame * tile_sheet.tile_size, 0, tile_sheet.tile_size, tile_sheet.tile_size, player.x, player.y, tile_sheet.tile_size*4, tile_sheet.tile_size*4);
  }
};

function cuttingAndDrawing(index){
